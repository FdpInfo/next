...
export function CommunityContent({
  ...
  const stats = [
    { num: "100K+", lbl: t.communityPage.statMembers },
    { num: "99.9%", lbl: t.communityPage.statUptime },
    { num: "90%", lbl: t.communityPage.statFeedback },
    { num: "2019", lbl: t.communityPage.statSince },
  ];
            ...
            <div className="mx-auto largura-maxima-48rem text-align-center">
              ...
              >
                ...
                <div>
                  ...
                  >
                    <span>{t.communityPage.visitSite}</span>
                  </a>
                </div>
              </div>
      ...
      <section className="zywl-relativo">
        <div className="mx-auto largura-maxima-72rem padding-left-right-1rem media-padding-horizontal-1-5rem">
          <div className="padding-top-4rem padding-bottom-3rem padding-inferior-8rem">
            <h2 className="cm-section-title">{t.communityPage.hubTitle}</h2>
            <p className="cm-section-sub">
              {t.communityPage.hubSub}
            </p>
            <CommunityCards
              discord={discord}
              githubReleases={githubReleases}
              githubIssueNew={githubIssueNew}
            />
          </div>
        </div>
      </section>
